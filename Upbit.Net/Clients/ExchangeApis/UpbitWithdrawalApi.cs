...
namespace Upbit.Net.Clients.ExchangeApis
{
    public class UpbitWithdrawalApi : BaseClient
    {
        ...
        public async Task<IEnumerable<UpbitTransfer>> GetWithdrawalListAsync(string currency = "", string state = "", IEnumerable<string>? uuids = null, IEnumerable<string>? txids = null, int limit = 100, int page = 1, UpbitSortType sortType = UpbitSortType.desc)
        {
